...
document.getElementById('btnNumber4').onclick = function () {
    ...
    if (toaDo1 >= toaDo2 && toaDo1 >= toaDo3) {
        ketQua =
            'Sinh viên: ' + tenSv1 + ' xa trường nhất với đoạn đường ' + toaDo1.toFixed(3) + 'm'
    } else if (toaDo2 >= toaDo1 && toaDo2 >= toaDo3) {
        ketQua =
            'Sinh viên: ' + tenSv2 + ' xa trường nhất với đoạn đường ' + toaDo2.toFixed(3) + 'm'
    } else if (toaDo3 >= toaDo1 && toaDo3 >= toaDo2) {
        ketQua =
            'Sinh viên: ' + tenSv3 + ' xa trường nhất với đoạn đường ' + toaDo3.toFixed(3) + 'm'
    }
